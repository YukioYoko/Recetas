    ...
    <div className="flex pt-20 px-10 font-body font-bold text-3xl min-h-screen text-custom-naranja-oscuro bg-custom-beige justify-around">
      <div className="flex flex-col w-7/12">
        ...
        <input
          ...
          name="nombreReceta"
          id="nombreReceta"
          className="w-7/12 text-2xl font-normal border border-custom-naranja-oscuro focus:outline-none rounded-md p-2 mt-3 mb-10"
        />
        <h3>Duracion</h3>
        <div className="flex text-xs gap-3 mt-3 mb-10">
          <div className="flex flex-col items-center">
            ...
            <input
              ...
              name="horasReceta"
              id="horasReceta"
              className="text-xl font-normal w-[60px] border border-custom-naranja-oscuro p-2 rounded-md"
            />
          </div>
          <div className="flex flex-col items-center">
            MINUTOS
        ...
        <input
          ...
          name="nombreReceta"
          id="nombreReceta"
          className="w-7/12 text-2xl font-normal border border-custom-naranja-oscuro focus:outline-none rounded-md p-2 my-3"
        />
        ...
        <input
          ...
          name="nombreReceta"
          id="nombreReceta"
          className="w-7/12 h-[200px] text-2xl font-normal border border-custom-naranja-oscuro focus:outline-none rounded-md p-2 mb-10"
        />
      </div>
