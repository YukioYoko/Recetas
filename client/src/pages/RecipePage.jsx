        ...
        <div className="grid grid-cols-3 gap-4 mt-16">
          ...
          <div className="col-span-2 row-span-2">
            ...
            <p className="font-body text-lg font-normal">
              ...
              15-20 minutos o hasta que la quinoa esté tierna y el líquido se
              haya absorbido. Retira del fuego y deja reposar tapado durante 5
              minutos. Mientras tanto, en una bandeja para hornear, coloca las
              tiras de pimiento, rodajas de calabacín, rodajas de berenjena y
              rodajas de cebolla roja. Rocía con aceite de oliva y sazona con
              sal y pimienta al gusto. Mezcla bien para cubrir todas las
              verduras con el aceite y las especias. Hornea las verduras en el
              horno precalentado durante 20-25 minutos o hasta que estén tiernas
              y ligeramente doradas, revolviendo ocasionalmente. En un tazón
              grande, combina la quinoa cocida y las verduras asadas. Agrega las
              hojas de albahaca picadas y mezcla suavemente. Sirve la ensalada
              de quinoa en platos individuales y espolvorea con queso feta
              desmenuzado, si lo deseas.
            </p>
          </div>
