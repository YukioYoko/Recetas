...
from .views import RegisterUserView, LoginUserView, SavedRecipeByCollectionView, EmailAPIView, GetUserByEmail, UserDeleteView
...
urlpatterns = [
    ...
    path('auth/users/', UserDeleteView.as_view(), name='auth'),
